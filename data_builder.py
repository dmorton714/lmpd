...
# urls = ['https://opendata.arcgis.com/datasets/beecd7d525ed44b6af7f75b114e35d53_0/FeatureServer/0']  # noqa
...
# df.to_csv(os.path.join(output_directory, 'employee.csv'), index=False)

# print(f"Data saved to {os.path.join(output_directory, 'employee.csv')}")
